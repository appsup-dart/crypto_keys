...
pc.Digest _digest(DigestAlgorithm id) =>
...
void main() {
  group('DigestAlgorithm', () {
    ...
    test('rsaPkcs1DigestIdentifierHex OID encodings', () {
      expect(DigestAlgorithm.sha256.rsaPkcs1DigestIdentifierHex,
          '0609608648016503040201');
      expect(DigestAlgorithm.sha3_256.rsaPkcs1DigestIdentifierHex,
          '0609608648016503040208');
      expect(DigestAlgorithm.sha512t(28).rsaPkcs1DigestIdentifierHex,
          '0609608648016503040205');
      expect(DigestAlgorithm.sha512t(32).rsaPkcs1DigestIdentifierHex,
