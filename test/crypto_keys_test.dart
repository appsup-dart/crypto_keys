  ...
  expect(
    decrypter.decrypt(
      encrypter.encrypt(
        data,
        initializationVector: encryptedData?.initializationVector,
        additionalAuthenticatedData: encryptedData?.additionalAuthenticatedData,
      ),
    ),
    data,
  );
  ...
  group('Encryption', () {
    ...
    group('Encryption with RSA keys', () {
      test('Example encryption using RSAES-PKCS1-v1_5', () {
        ...
        _testEncryption(
          keyPair,
          algorithms.encryption.rsa.pkcs1,
          data,
          encryptedData,
          true,
        );
      ...
      test('Example encryption using RSAES-OAEP-256', () {
        var jwk = {
          'kty': 'RSA',
          'n':
              '2cQJH1f6yF9DcGa8Cmbnhn4LHLs5L6kNb2rxkrNFZArJLRaKvaC3tMCKZ8Zg'
          ...
          'e': 'AQAB',
          'd':
              'dyUz3ItVceX1Tv1WqtZMnKA_0jN5gWMcL7ayf5JISAlCssGfnUre2C10TH0U'
          ...
          'qi':
              'vy7XCwZ3jyMGik81TIZDAOQKC8FVUc0TG5KVYfti4tgw'
        ...
        var data = base64Url.decode(
          'A0lSKnZfXznJcsx6nRs78tJw9EqXfaCn-tbsMxvITdA=',
        );

        _testEncryption(
          keyPair,
          algorithms.encryption.rsa.oaep256,
          data,
          encryptedData,
          true,
        );
